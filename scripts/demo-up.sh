...
# ...and the half face BEHIND SOMEONE (2026-09-25, run 125001's p00005 on the
# strict gate): a face 30% or more inside the head of a person nearer the
# camera (feet lower in the frame) is not counted. Applies under every
# console quality profile. 0 turns it off.
export HECO_QUALITY_MAX_HEAD_OVERLAP=${HECO_QUALITY_MAX_HEAD_OVERLAP:-0.3}
